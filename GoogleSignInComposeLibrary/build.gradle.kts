...
mavenPublishing {
    ...
    pom {
        ...
        description.set(
            "Google Sign In Button Library for use in Android Jetpack Compose with Material 3."
        )
        inceptionYear.set("2026")
        url.set("https://github.com/joyner-perez/GoogleSignInButtonLibrary")
        licenses {
            license {
                name.set("MIT")
        ...
        scm {
            url.set("https://github.com/joyner-perez/GoogleSignInButtonLibrary")
            connection.set("scm:git:git://github.com/joyner-perez/GoogleSignInButtonLibrary.git")
            developerConnection.set(
                "scm:git:ssh://git@github.com/joyner-perez/GoogleSignInButtonLibrary.git"
            )
        }
    }
}
